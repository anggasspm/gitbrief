...
import { IconGitCommit, IconGitPullRequest, IconExternalLink } from '@/components/Icons'
...
export default function PrPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/explain/pr', {
      ...
      body: JSON.stringify({ url: `https://github.com/${owner}/${repo}/pull/${number}`, lang }),
    })
      .then(res => res.json())
      .then(json => {
        if (cancelled) return
